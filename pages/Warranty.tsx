    ...
    <div className="py-16 bg-white min-h-screen">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="text-center mb-12">
          <ShieldCheck className="w-24 h-24 text-brand-orange mx-auto mb-6" />
          <h1 className="text-4xl font-heading font-black text-brand-navy mb-4">Up to 60-Day Warranty</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-green-50 p-8 rounded-xl border border-green-100">
            <h3 className="text-xl font-bold text-green-900 mb-6 flex items-center gap-2">
              <Check className="w-6 h-6 text-green-600" /> What's Covered
            </h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-green-900">
                <span className="w-1.5 h-1.5 bg-green-600 rounded-full mt-2.5"></span>
          ...
          <div className="bg-red-50 p-8 rounded-xl border border-red-100">
            <h3 className="text-xl font-bold text-red-900 mb-6 flex items-center gap-2">
              <X className="w-6 h-6 text-red-600" /> Not Covered
            </h3>
            <ul className="space-y-4">
        ...
        <div className="bg-brand-navy rounded-xl p-8 text-center text-white shadow-xl">
          <p className="text-xl font-bold mb-6 font-heading">
